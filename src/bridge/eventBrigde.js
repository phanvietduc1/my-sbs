export const ACTIONS = {
  ...
  // Clipboard cases
  COPY: 'COPY',
  REQUEST_CLIPBOARD_STATE: 'REQUEST_CLIPBOARD_STATE',
  PASTE: 'PASTE',
  PASTE_RESULT: 'PASTE_RESULT',
  CLIPBOARD_STATE: 'CLIPBOARD_STATE',

  // Modal actions
  OPEN_MODAL_SWITCH_URL: 'openModalSwitchURL',

  // Biometric actions
  BIOMETRIC_REGISTER: 'biometricRegister',
  BIOMETRIC_SAVE_TOKEN: 'biometricSaveToken',
};
class EventBridge {
  /**
   * Constructor
